...
#define WEBSOCKETS_NETWORK_TYPE  1 //ARDUINO
...
class WebSockets {
    protected:
        typedef void (*WSreadWaitCb)(WebSockets  * ws, size_t size,WSclient_t * client, bool ok) ;


		static void readWaitcallBack(WebSockets * ws,size_t size,WSclient_t * client, bool ok);
